...
The first two axes are shown below, but I recommend exploring all nine
...
Based on these curves, I chose six, four, and four clusters for the population
...
amovaIntermediate$varcomp
```

We can see that these four DAPC clusters explain 16.3% of the molecular variance.
